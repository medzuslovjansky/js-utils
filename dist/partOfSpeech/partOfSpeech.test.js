...
describe('parsePos', () => {
    test.each([
        ...
        ['v.tr.ipf', { name: 'verb', transitive: true, imperfective: true }],
    ])('should expand %j to object', (abbr, expected) => {
        const actual = (0, partOfSpeech_1.parsePos)(abbr);
        if (!actual) {
    ...
    it('should throw for non-strings', () => {
        expect(() => (0, partOfSpeech_1.parsePos)(null)).toThrowErrorMatchingInlineSnapshot('"Expected a string, but got: null"');
    });
    it('should throw for unknown abbreviations', () => {
        expect(() => (0, partOfSpeech_1.parsePos)('unknown')).toThrowErrorMatchingInlineSnapshot('"Failed to parse the part of speech in: unknown"');
    });
});
//# sourceMappingURL=partOfSpeech.test.js.map