...
exports.transliterate = exports.FlavorizationType = exports.TransliterationType = void 0;
const constants_1 = require("../constants");
var TransliterationType;
(function (TransliterationType) {
    TransliterationType[TransliterationType["Latin"] = 1] = "Latin";
    TransliterationType[TransliterationType["ASCII"] = 2] = "ASCII";
    TransliterationType[TransliterationType["Polish"] = 3] = "Polish";
    TransliterationType[TransliterationType["StandardCyrillic"] = 5] = "StandardCyrillic";
    TransliterationType[TransliterationType["TraditionalIotatedCyrillic"] = 6] = "TraditionalIotatedCyrillic";
    TransliterationType[TransliterationType["Glagolitic"] = 7] = "Glagolitic";
    TransliterationType[TransliterationType["IPA"] = 10] = "IPA";
})(TransliterationType = exports.TransliterationType || (exports.TransliterationType = {}));
var FlavorizationType;
(function (FlavorizationType) {
    FlavorizationType[FlavorizationType["CyrillicExtended"] = 1] = "CyrillicExtended";
    FlavorizationType[FlavorizationType["Etymological"] = 2] = "Etymological";
    FlavorizationType[FlavorizationType["Standard"] = 3] = "Standard";
    FlavorizationType[FlavorizationType["Slovianto"] = 4] = "Slovianto";
    FlavorizationType["Southern"] = "J";
    FlavorizationType["Northern"] = "S";
})(FlavorizationType = exports.FlavorizationType || (exports.FlavorizationType = {}));
/**
 * @param iSource
 * @param type
 * @param flav
 ...
 */
function transliterate(iSource, type, flav = 2, preprocessed = false) {
    return iSource.normalize('NFC').replace(/[\p{Letter}\p{Mark}]+/gu, (word) => {
        ...
        return transliterateWord(preprocess(OrigW.toLowerCase()), OrigW, type, flav);
    });
}
exports.transliterate = transliterate;
const VOWEL = /[aeiouyąęųåėȯèòěê]/;
function transliterateWord(__iW, __OrigW, type, flav) {
    let iW = __iW;
    let OrigW = __OrigW;
    ...
    if (type == 5 || type == 6) {
        ...
        iW = iW.replace(/([ln])ьę/g, '$1' + constants_1.Glagolitic.Iotated_Small_Yus);
        iW = iW.replace(/([ln])ьų/g, '$1' + constants_1.Glagolitic.Iotated_Big_Yus);
        iW = iW.replace(/([dzrstln])ьu/g, '$1' + constants_1.Glagolitic.Yu);
        iW = iW.replace(/([dzrstln])ьa/g, '$1' + constants_1.Glagolitic.Trokutasti_A);
        iW = iW.replace(/([dzrstln])ьje/g, '$1' + constants_1.Glagolitic.Yeri + constants_1.Glagolitic.Yestu);
        iW = iW.replace(/([dzrstln])ьję/g, '$1' + constants_1.Glagolitic.Iotated_Small_Yus);
        iW = iW.replace(/([dzrstln])ьji/g, '$1' + constants_1.Glagolitic.Izhe + constants_1.Glagolitic.I);
        iW = iW.replace(/([dzrstln])ьju/g, '$1' + constants_1.Glagolitic.Yeri + constants_1.Glagolitic.Yu);
        iW = iW.replace(/([dzrstln])ьjų/g, '$1' + constants_1.Glagolitic.Iotated_Big_Yus);
        iW = iW.replace(/([dzrstln])ьja/g, '$1' + constants_1.Glagolitic.Yeri + constants_1.Glagolitic.Trokutasti_A);
        iW = iW.replace(/([dzrstln])ьjo/g, '$1' + constants_1.Glagolitic.Yo);
        iW = iW.replace(/([%aeėioȯuyąęųåěê])jo/g, '$1' + constants_1.Glagolitic.Izhe + constants_1.Glagolitic.Onu);
        iW = iW.replace(/je/g, constants_1.Glagolitic.Izhe + constants_1.Glagolitic.Yestu);
        iW = iW.replace(/ję/g, constants_1.Glagolitic.Iotated_Small_Yus);
        iW = iW.replace(/ji/g, constants_1.Glagolitic.Izhe + constants_1.Glagolitic.I);
        iW = iW.replace(/ju/g, constants_1.Glagolitic.Yu);
        iW = iW.replace(/jų/g, constants_1.Glagolitic.Iotated_Big_Yus);
        iW = iW.replace(/ja/g, constants_1.Glagolitic.Trokutasti_A);
        iW = iW.replace(/jo/g, constants_1.Glagolitic.Yo);
        iW = iW.replace(/lj/g, constants_1.Glagolitic.Ljudije + constants_1.Glagolitic.Yeri);
        iW = iW.replace(/nj/g, constants_1.Glagolitic.Nashi + constants_1.Glagolitic.Yeri);
        iW = iW.replace(/(šč|šć)/g, constants_1.Glagolitic.Shta);
        iW = iW.replace(/a/g, constants_1.Glagolitic.Azu);
        iW = iW.replace(/å/g, constants_1.Glagolitic.Otu);
        iW = iW.replace(/b/g, constants_1.Glagolitic.Buky);
        iW = iW.replace(/c/g, constants_1.Glagolitic.Tsi);
        iW = iW.replace(/ć/g, constants_1.Glagolitic.Shta);
        iW = iW.replace(/č/g, constants_1.Glagolitic.Chrivi);
        iW = iW.replace(/[dḓ]/g, constants_1.Glagolitic.Dobro);
        iW = iW.replace(/dž/g, constants_1.Glagolitic.Dobro + constants_1.Glagolitic.Zhivete);
        iW = iW.replace(/đ/g, constants_1.Glagolitic.Djervi);
        iW = iW.replace(/[eė]/g, constants_1.Glagolitic.Yestu);
        iW = iW.replace(/ę/g, constants_1.Glagolitic.Small_Yus);
        iW = iW.replace(/[êě]/g, constants_1.Glagolitic.Yati);
        iW = iW.replace(/f/g, constants_1.Glagolitic.Fritu);
        iW = iW.replace(/g/g, constants_1.Glagolitic.Glagoli);
        iW = iW.replace(/h/g, constants_1.Glagolitic.Heru);
        iW = iW.replace(/i/g, constants_1.Glagolitic.I);
        iW = iW.replace(/j/g, constants_1.Glagolitic.Izhe);
        iW = iW.replace(/k/g, constants_1.Glagolitic.Kako);
        iW = iW.replace(/l/g, constants_1.Glagolitic.Ljudije);
        iW = iW.replace(/m/g, constants_1.Glagolitic.Latinate_Myslite);
        iW = iW.replace(/n/g, constants_1.Glagolitic.Nashi);
        iW = iW.replace(/o/g, constants_1.Glagolitic.Onu);
        iW = iW.replace(/ȯ/g, constants_1.Glagolitic.Yeru);
        iW = iW.replace(/p/g, constants_1.Glagolitic.Pokoji);
        iW = iW.replace(/[rṙ]/g, constants_1.Glagolitic.Ritsi);
        iW = iW.replace(/s/g, constants_1.Glagolitic.Slovo);
        iW = iW.replace(/š/g, constants_1.Glagolitic.Sha);
        iW = iW.replace(/[tṱ]/g, constants_1.Glagolitic.Tvrido);
        iW = iW.replace(/u/g, constants_1.Glagolitic.Uku);
        iW = iW.replace(/ų/g, constants_1.Glagolitic.Big_Yus);
        iW = iW.replace(/[vŭ]/g, constants_1.Glagolitic.Vedi);
        iW = iW.replace(/y/g, constants_1.Glagolitic.Yeri + constants_1.Glagolitic.Izhe);
        iW = iW.replace(/z/g, constants_1.Glagolitic.Zemlja);
        iW = iW.replace(/ž/g, constants_1.Glagolitic.Zhivete);
        iW = iW.replace(/ь/g, constants_1.Glagolitic.Yeri);
        iW = iW.replace(/[’#]/g, constants_1.Glagolitic.Yeru);
        iW = iW.replace(/`/g, '’');
    }
    else if (type == 10) {
        /* IPA */
