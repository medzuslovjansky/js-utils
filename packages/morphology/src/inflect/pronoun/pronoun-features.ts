...
/**
 * Who the possessor is. Read only for a `pron.poss.` lemma: `jego`, `jej` and
 * `jih` are also the oblique forms of `on`, and a personal pronoun has no
 * possessor to describe.
 */
export const POSSESSOR_FEATURES: Record<string, TokenFeatures> = {
